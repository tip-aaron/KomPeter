...
-- ===============================================
-- 2. INVENTORY SETUP (70 Items - No Change)
-- ===============================================
...
-- ===============================================
-- 3. PURCHASES (Restocking - No Change)
-- ===============================================
...
(1, 1, 2, 5, 5, 10000.00),  
(2, 1, 5, 20, 20, 1000.00), 
(3, 2, 21, 10, 10, 8000.00), 
(4, 2, 23, 10, 10, 2000.00),
(5, 3, 37, 1, 0, 40000.00), 
(6, 4, 7, 10, 10, 12500.00);
...
-- Sale Item Stocks (15 sales * 2 items each = 30 rows for variety)
INSERT INTO sale_item_stocks (_sale_item_id, _sale_id, _item_stock_id, quantity, unit_price_php) VALUES
-- Sale 1 (Total: 15500)
(1, 1, 5, 2, 3500.00),   -- 2 RAMs (Stock ID 5)
(2, 1, 21, 1, 8500.00),  -- 1 Keyboard (Stock ID 21)
-- Sale 2 (Total: 12000)
(3, 2, 2, 1, 12000.00),  -- 1 CPU (Stock ID 2)
(4, 2, 57, 1, 350.00),   -- 1 Thermal Paste (Stock ID 57)
-- Sale 3 (Total: 2500)
(5, 3, 23, 1, 2500.00),  -- 1 Mouse (Stock ID 23)
(6, 3, 62, 10, 300.00),  -- 10 Cable Ties (Stock ID 62)
-- Sale 4 (Total: 19000)
(7, 4, 25, 1, 18000.00), -- 1 Monitor (Stock ID 25)
(8, 4, 56, 2, 500.00),   -- 2 Adapters (Stock ID 56)
-- Sale 5 (Total: 45500)
(9, 5, 37, 1, 45000.00), -- 1 ZenBook 14 (Stock ID 37)
(10, 5, 69, 1, 800.00),  -- 1 USB Hub (Stock ID 69)
-- Sale 6 (Total: 85500)
(11, 6, 38, 1, 85000.00), -- 1 ROG Zephyrus (Stock ID 38)
(12, 6, 3, 1, 12500.00),  -- 1 SSD (Stock ID 3)
-- Sale 7 (Total: 14000)
(13, 7, 7, 1, 12500.00),  -- 1 SSD (Stock ID 7)
(14, 7, 29, 1, 4000.00),  -- 1 Headset (Stock ID 29)
-- Sale 8 (Total: 77500)
(15, 8, 43, 1, 70000.00), -- 1 Dell XPS 13 (Stock ID 43)
(16, 8, 24, 1, 3500.00),  -- 1 Logitech G502 (Stock ID 24)
-- Sale 9 (Total: 120000)
(17, 9, 54, 1, 120000.00), -- 1 Alienware M18 (Stock ID 54)
(18, 9, 65, 1, 7000.00),   -- 1 Win 11 License (Stock ID 65)
-- Sale 10 (Total: 18000)
(19, 10, 11, 2, 9000.00),  -- 2 Motherboards (Stock ID 11)
(20, 10, 13, 1, 4500.00),  -- 1 PSU (Stock ID 13)
-- Sale 11 (Total: 6500)
(21, 11, 27, 1, 3500.00),  -- 1 Webcam (Stock ID 27)
(22, 11, 32, 1, 2500.00),  -- 1 Speakers (Stock ID 32)
-- Sale 12 (Total: 5000)
(23, 12, 56, 5, 500.00),   -- 5 Adapters (Stock ID 56)
(24, 12, 63, 5, 450.00),   -- 5 Canned Air (Stock ID 63)
-- Sale 13 (Total: 65500)
(25, 13, 51, 1, 65000.00), -- 1 Surface Laptop (Stock ID 51)
(26, 13, 70, 1, 2000.00),  -- 1 Laptop Backpack (Stock ID 70)
-- Sale 14 (Total: 4000)
(27, 14, 33, 1, 7000.00),  -- 1 Blue Yeti Mic (Stock ID 33)
(28, 14, 59, 1, 500.00),   -- 1 Mousepad (Stock ID 59)
-- Sale 15 (Total: 35000)
(29, 15, 3, 2, 12500.00),  -- 2 SSDs (Stock ID 3)
(30, 15, 66, 1, 4500.00);  -- 1 Office License (Stock ID 66)
...
-- Sale 1: 15500.00 * 1.12 = 17360.00 (Cash)
(1, 1, DATETIME('now', '-14 days', '10:05:00'), NULL, 'cash', 17360.00), 
-- Sale 2: 12350.00 * 0.90 * 1.12 = 12412.80 (GCash)
(2, 2, DATETIME('now', '-14 days', '14:35:00'), 'GCASH-0914', 'gcash', 12412.80), 
-- Sale 3: (5500.00 - 100.00) * 1.12 = 6048.00 (Cash)
(3, 3, DATETIME('now', '-13 days', '09:20:00'), NULL, 'cash', 6048.00), 
-- Sale 4: 19000.00 * 1.12 = 21280.00 (Bank Transfer)
(4, 4, DATETIME('now', '-13 days', '16:05:00'), 'BTRANS-0913', 'bank_transfer', 21280.00),
-- Sale 5: 45800.00 * 0.95 * 1.12 = 48774.40 (GCash)
(5, 5, DATETIME('now', '-12 days', '11:25:00'), 'GCASH-0912', 'gcash', 48774.40),
-- Sale 6: (97500.00 - 500.00) * 1.12 = 108640.00 (Bank Transfer)
(6, 6, DATETIME('now', '-11 days', '15:50:00'), 'BTRANS-0911', 'bank_transfer', 108640.00),
-- Sale 7: 16500.00 * 1.12 = 18480.00 (Cash)
(7, 7, DATETIME('now', '-10 days', '13:05:00'), NULL, 'cash', 18480.00),
-- Sale 8: 73500.00 * 0.85 * 1.12 = 69972.00 (Bank Transfer)
(8, 8, DATETIME('now', '-9 days', '10:35:00'), 'BTRANS-0909', 'bank_transfer', 69972.00),
-- Sale 9: (127000.00 - 2000.00) * 1.12 = 139440.00 (Bank Transfer)
(9, 9, DATETIME('now', '-8 days', '17:05:00'), 'BTRANS-0908', 'bank_transfer', 139440.00),
-- Sale 10: 22500.00 * 1.12 = 25200.00 (Cash)
(10, 10, DATETIME('now', '-7 days', '12:05:00'), NULL, 'cash', 25200.00),
-- Sale 11: 6000.00 * 0.97 * 1.12 = 6523.20 (GCash)
(11, 11, DATETIME('now', '-6 days', '14:15:00'), 'GCASH-0906', 'gcash', 6523.20),
-- Sale 12: (5000.00 - 1000.00) * 1.12 = 4480.00 (Cash)
(12, 12, DATETIME('now', '-5 days', '09:45:00'), NULL, 'cash', 4480.00),
-- Sale 13: 67000.00 * 1.12 = 75040.00 (Bank Transfer)
(13, 13, DATETIME('now', '-4 days', '18:05:00'), 'BTRANS-0904', 'bank_transfer', 75040.00),
-- Sale 14: 7500.00 * 0.95 * 1.12 = 7980.00 (GCash)
(14, 14, DATETIME('now', '-3 days', '12:00:00'), 'GCASH-0903', 'gcash', 7980.00),
-- Sale 15: 35000.00 * 1.12 = 39200.00 (Cash)
