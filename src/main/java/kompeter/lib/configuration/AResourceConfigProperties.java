...
public abstract class AResourceConfigProperties extends AResourceConfig {
    ...
    public AResourceConfigProperties() {
        ...
        LOGGER.info("Initializing configuration in resource for path: " + getFileDirectory() + getFileName()
        ...
        try {
            ...
            LOGGER.info("Successfully loaded configuration from resource for path: " + getFileDirectory()
                    + getFileName() + " for class: " + classNameString);
        } catch (final IOException e) {
            LOGGER.severe("Failed to load properties file: " + getFileName() + "\n" + e);
        } catch (final IllegalArgumentException e) {
            LOGGER.severe("getFileName() or getFilePath() returned null or empty string. \n" + e);
        }
    }
